<div id="herosection" class="w-[80vw] h-[80vh] mx-auto flex relative text-white">
    <div class=" w-[50vw] h-full  ">
        <div class="bg-transparent h-[50%] w-[80%] absolute top-10 ">
            <h1 class="uppercase text-white font-bold text-[75px]">Every <span class="text-[#fff500]">great transformation</span>  starts with a single step, <span class="text-[#fff500]">take yours today</span></h1>
