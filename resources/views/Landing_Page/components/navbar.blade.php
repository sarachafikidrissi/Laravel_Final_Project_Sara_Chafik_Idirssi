<div class="bg-black h-[10vh] flex items-center justify-around">
    ...
    <div class="flex gap-x-4 items-center ">
        ...
        <a href="{{ route('trainer') }}" class="bg-[#FF9D52] rounded-xl hover:rounded-none cursor-pointer  text-black hover:bg-black hover:text-[#FF9D52] hover:border hover:border-[#FF9D52] px-4 py-2 font-bold ">Become a member</a>
